...
The `titled.tuesday` R package is an interface with the [Chess.com API](https://www.chess.com/news/view/published-data-api). It's capable of downloading and parsing data such as:

* Titled Tuesday standings;

* Titled Tuesday games, including the players, their ratings, and even accuracy scores;
